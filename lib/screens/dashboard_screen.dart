...
class _DashboardScreenState extends State<DashboardScreen> {
    ...
    return Drawer(
      ...
      child: ListView(
        ...
        children: [
          ...
          _buildNavigationItem(Icons.web, 'Web Preview', 4),
          const Divider(),
  ...
  Widget _buildBody() {
    switch (_selectedIndex) {
      ...
      case 4:
        return _buildWebPreviewTab();
      default:
        return _buildDashboardTab();
    }
  }

  Widget _buildWebPreviewTab() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Test iframe functionality by previewing web content within the app.',
            ...
            child: GridView.count(
              ...
              children: [
                _buildWebPreviewCard(
                  'BBB Flutter App',
                  'https://app.bbb.co.za/catalogue?docUrl=https://viewer.ipaper.io/botle-buhle-brands/sales-force-portal/catalogues/current/&pageName=August+2025',
                  Icons.business,
                  Colors.blue,
                ),
                _buildWebPreviewCard(
                  'iPaper Super Specials',
                  'https://viewer.ipaper.io/botle-buhle-brands/south-africa/2025/april/super-specials/',
                  Icons.article,
                  Colors.orange,
                ),
                _buildWebPreviewCard(
      ...
      child: InkWell(
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => WebEmbedScreen(
                title: title,
                url: url,
              ),
            ),
